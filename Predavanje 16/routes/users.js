...
const authService = require('../config/authMiddleware')
...
router.get('/', authService.authentificate, async (req, res) => {
    try {
...
router.delete('/:id', authService.authentificate, authService.authorizedAdmin, async (req, res) => {
    try {
